...
def generate_adventure_stages():
    ...
    for stage_id in range(1, 201):
        ...
        if stage_id <= 40:
            difficulty = '쉬움'
            enemy_count = 1
            hp_mult = 1.0 + (stage_id - 1) * 0.02
            atk_mult = 1.0 + (stage_id - 1) * 0.01
            rarities = ['레어']
            skill_reward = 0.02 + (stage_id - 1) * 0.002
        elif stage_id <= 80:
            difficulty = '보통'
            enemy_count = 1 + (stage_id - 40) // 15  # 1~3마리
            hp_mult = 1.6 + (stage_id - 40) * 0.04
            atk_mult = 1.3 + (stage_id - 40) * 0.015
            rarities = ['레어', '에픽']
            skill_reward = 0.05 + (stage_id - 40) * 0.002
        elif stage_id <= 120:
            difficulty = '어려움'
            enemy_count = 2 + (stage_id - 80) // 15  # 2~4마리
            hp_mult = 2.8 + (stage_id - 80) * 0.04
            atk_mult = 1.8 + (stage_id - 80) * 0.015
            rarities = ['에픽', '유니크']
            skill_reward = 0.07 + (stage_id - 80) * 0.001
        elif stage_id <= 160:
            difficulty = '매우 어려움'
            enemy_count = 3 + (stage_id - 120) // 15  # 3~5마리
            hp_mult = 3.8 + (stage_id - 120) * 0.04
            atk_mult = 2.2 + (stage_id - 120) * 0.01
            rarities = ['유니크', '레전드리']
            skill_reward = 0.09 + (stage_id - 120) * 0.0005
        else:
            difficulty = '극악'
            enemy_count = 4 + (stage_id - 160) // 10  # 4~8마리
            hp_mult = 4.8 + (stage_id - 160) * 0.04
            atk_mult = 2.6 + (stage_id - 160) * 0.01
            rarities = ['레전드리']
