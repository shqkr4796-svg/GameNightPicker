...
def get_drama_conversations():
    ...
    return [
        ...
        {'scene': '영화 다 본 후 친구와 대화', 'turns': [{'ai_prompt': 'What did you think of the movie?', 'ai_meaning': '영화 어땠어?', 'user_response': 'It was amazing! The ending was so unexpected!', 'user_meaning': '정말 좋았어! 결말이 예상 밖이었어!'}, {'ai_prompt': 'Right? I didn\'t see that coming either.', 'ai_meaning': '맞아? 나도 몰랐어.'}, {'ai_prompt': 'Shall we grab dinner and discuss it more?', 'ai_meaning': '저녁 먹으면서 더 얘기할까?', 'user_response': 'Perfect! I\'m starving anyway!', 'user_meaning': '좋아! 나도 배고프니까!'}]},
        ...
        {'scene': '회사 휴게실에서 점심', 'turns': [{'ai_prompt': 'Hey, want to grab lunch together?', 'ai_meaning': '안녕, 함께 점심 먹을래?', 'user_response': 'Sure! I packed a sandwich though.', 'user_meaning': '좋아! 그런데 난 샌드위치를 싸왔어.'}, {'ai_prompt': 'That\'s fine. We can eat together anyway.', 'ai_meaning': '괜찮아. 어쨌든 함께 먹을 수 있어.'}, {'ai_prompt': 'How\'s the project going?', 'ai_meaning': '프로젝트는 어떻게 진행되고 있어?', 'user_response': 'It\'s almost done. Should be finished by Friday!', 'user_meaning': '거의 다 됐어. 금요일까지 끝날 거야!'}]},
        ...
        {'scene': '불 나고 응급 상황', 'turns': [{'ai_prompt': 'Call 911! There\'s a fire!', 'ai_meaning': '911에 전화해! 불이 났어!'}, {'ai_prompt': 'I\'m calling now! Everyone evacuate!', 'ai_meaning': '지금 전화할게! 모두 대피해!', 'user_response': 'Get out now! Meet at the parking lot!', 'user_meaning': '지금 나가! 주차장에서 만나자!'}]},
        ...
        {'scene': '온라인 쇼핑 반품', 'turns': [{'ai_prompt': 'I need to return this item. It doesn\'t fit.', 'ai_meaning': '이 물건을 반품해야 합니다. 사이즈가 안 맞네요.'}, {'ai_prompt': 'No problem. We have a 30-day return policy.', 'ai_meaning': '괜찮습니다. 30일 반품 정책이 있습니다.', 'user_response': 'Great! How long will the refund take?', 'user_meaning': '좋습니다! 환불은 얼마나 걸려요?'}]},
        ...
        {'scene': '신문배달원과 계약 취소', 'turns': [{'ai_prompt': 'I\'d like to cancel my newspaper subscription.', 'ai_meaning': '신문 구독을 취소하고 싶습니다.'}, {'ai_prompt': 'May I ask why?', 'ai_meaning': '이유를 물어봐도 될까요?', 'user_response': 'I\'ve switched to reading news online.', 'user_meaning': '온라인에서 뉴스를 읽기로 바꿨어요.'}]},
        ...
        {'scene': '친구와 싸운 후 화해', 'turns': [{'ai_prompt': 'I\'m sorry about what I said. I didn\'t mean it.', 'ai_meaning': '제가 말한 것에 대해 미안합니다. 진심이 아니었어요.'}, {'ai_prompt': 'I know. I was upset too.', 'ai_meaning': '알아요. 나도 화났었어요.', 'user_response': 'Can we just move past it? You\'re my best friend.', 'user_meaning': '그냥 넘어가자. 넌 내 친구 중 최고야.'}]},
        ...
        {'scene': '인테리어 디자이너 상담', 'turns': [{'ai_prompt': 'Tell me about your vision for this room.', 'ai_meaning': '이 방에 대한 당신의 비전을 말씀해주세요.'}, {'ai_prompt': 'I want something modern but warm.', 'ai_meaning': '현대적이지만 따뜻한 분위기를 원해요.', 'user_response': 'I can make that happen. Let me show you some options.', 'user_meaning': '그렇게 할 수 있어요. 옵션을 보여드릴게요.'}]},
        ...
        {'scene': '차 사기 협상', 'turns': [{'ai_prompt': 'This car is in excellent condition.', 'ai_meaning': '이 차는 정말 좋은 상태입니다.'}, {'ai_prompt': 'How much are you asking?', 'ai_meaning': '얼마를 원하세요?', 'user_response': '$15,000, but I\'m willing to negotiate.', 'user_meaning': '$15,000인데 협상할 수 있어요.'}]},
        ...
        {'scene': '케이크 가게에서 결혼식 케이크 주문', 'turns': [{'ai_prompt': 'Congratulations on your engagement!', 'ai_meaning': '약혼을 축하합니다!'}, {'ai_prompt': 'Thank you! We\'d like to order a wedding cake.', 'ai_meaning': '감사합니다! 웨딩 케이크를 주문하고 싶어요.', 'user_response': 'What flavors do you prefer?', 'user_meaning': '어떤 맛을 선호하세요?'}]},
        ...
        {'scene': '여행 가이드 투어 시작', 'turns': [{'ai_prompt': 'Welcome to our city tour. I\'m your guide today.', 'ai_meaning': '도시 투어에 오신 것을 환영합니다. 저는 오늘 가이드입니다.'}, {'ai_prompt': 'This building is 200 years old and has great history.', 'ai_meaning': '이 건물은 200년 되었고 큰 역사가 있어요.', 'user_response': 'Fascinating! Can you tell us more?', 'user_meaning': '흥미로워요! 더 말씀해주실 수 있어요?'}]},
        {'scene': '프로젝트 완료 축하 파티', 'turns': [{'ai_prompt': 'Great work everyone! The project is a success!', 'ai_meaning': '모두 좋은 일해요! 프로젝트가 성공했어요!'}, {'ai_prompt': 'Let\'s celebrate! Drinks are on me!', 'ai_meaning': '축하해요! 내가 쏘는 술이에요!', 'user_response': 'Thank you! We worked really hard for this.', 'user_meaning': '감사합니다! 정말 열심히 일했어요.'}]},
        ...
        {'scene': '번지 점프 모험 활동', 'turns': [{'ai_prompt': 'Are you ready? It\'s quite a drop.', 'ai_meaning': '준비됐어요? 꽤 높아요.', 'user_response': 'I\'ve trained for this. Let\'s do it!', 'user_meaning': '이를 위해 훈련했어요. 해봐요!'}, {'ai_prompt': 'Okay! Remember to jump on three.', 'ai_meaning': '좋아요! 3일 때 점프하는 거 기억해요.'}, {'ai_prompt': '3! 2! 1! Jump!', 'ai_meaning': '3! 2! 1! 점프!'}, {'ai_prompt': 'Wow! That was amazing!', 'ai_meaning': '와! 정말 대단했어!', 'user_response': 'That was the most thrilling experience!', 'user_meaning': '가장 설레는 경험이었어!'}]},
        {'scene': '금고 개설 은행 방문', 'turns': [{'ai_prompt': 'I\'d like to open a safe deposit box.', 'ai_meaning': '금고를 열고 싶어요.'}, {'ai_prompt': 'We have several sizes available. What do you need it for?', 'ai_meaning': '여러 사이즈가 있어요. 뭐에 사용할 거예요?'}, {'ai_prompt': 'To store important documents and valuables.', 'ai_meaning': '중요 문서와 귀중품을 보관하려고.'}, {'ai_prompt': 'Perfect. Let me show you what we have.', 'ai_meaning': '좋습니다. 뭐가 있는지 보여드릴게요.'}]},
